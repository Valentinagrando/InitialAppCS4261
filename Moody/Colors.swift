...
class Colors: ObservableObject {
    ...
    @Published var selectedBackgroundColor: Color = Color.pink
    @Published var goodBackgroundColor: Color = Color.green
    @Published var mehBackgroundColor: Color = Color.orange
    @Published var badBackgroundColor: Color = Color.red
